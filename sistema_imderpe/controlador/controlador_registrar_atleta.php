...
if (!empty($_POST["btn_registrar"])) {
    ...
    $sql = $conexion->query("INSERT INTO atletas (cedula, nombre, apellido, fecha_nacimiento, genero, representante_id, entrenador_id, disciplina_id, estado) 
                             VALUES ('$cedula', '$nombre', '$apellido', '$fecha', '$genero', $representante_id, $entrenador_id, $disciplina_id, '$estado')");
